...
public class Application {
    ...
    insert into sch_timetable (task_id, name, service, executor, weight, type, param) values ('1', 'Simple periodic task', 'main', 'com.github.sc.scheduler.example.SleepTaskExecutor', 1, 'PERIOD', '1');
    commit;
     */
}
